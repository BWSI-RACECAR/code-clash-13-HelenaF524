...
class Solution:
    def matrix_mult(self,m1, m2):
        ...
        # row 1 into each column

        r1c1 = m1[0][0]*m2[0][0] + m1[0][1]*m2[1][0]
        r1c2 = m1[0][0]*m2[0][1] + m1[0][1]*m2[1][1]
        r2c1 = m1[1][0]*m2[0][0] + m1[1][1]*m2[1][0]
        r2c2 = m1[1][0]*m2[0][1] + m1[1][1]*m2[1][1]
